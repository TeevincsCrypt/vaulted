...
export const VAULTED_ESCROW_ABI = [
  {
    "inputs": [
      {
  ...
  },
  {
    ...
    "name": "AmountExceedsEscrow",
    "type": "error"
  },
  {
    "inputs": [],
    "name": "ArbitrationUnavailable",
    "type": "error"
  },
  {
    "inputs": [
  ...
  },
  {
    ...
    "name": "ProtectionPeriodOutOfRange",
    "type": "error"
  },
  {
    "inputs": [
  ...
  {
    "inputs": [],
    "name": "DEFAULT_PROTECTION_PERIOD",
    "outputs": [
      {
        "internalType": "uint64",
        "name": "",
